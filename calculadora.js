...
//    CORRECCIÓN APLICADA: LM (Largo de Manga) ahora es Sisa a Puño (51 cm para talla 46)
// ====================================================================
...
function manejarVisibilidadCampos() {
    ...
    if (!metodoGroup || !cmGroup || !tallaSelect) return; 
...
function calcularPatron() {
    ...
    if (metodoTejido === "BAJO" && densidadH) {
        ...
        // CORRECTO: Usar medidas.LM directamente para el largo de manga restante.
